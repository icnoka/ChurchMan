<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="index.html">Church Management System</a>
  </div>
      ...
      <ul class="nav" id="side-menu">
        ...
        <li>
          ...
          <ul class="nav nav-second-level">
            <li>
              <a href="member-search.php">Search Member</a>
            </li>
            <li>
              <a href="add-course.php">Add Member</a>
            </li>
          </ul>
        </li>
        <li>
          <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Tithe<span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li>
              <a href="add-subject.php">Add Tithe</a>
            </li>
            <li>
